    ...
    >
      <div style={{ marginBottom: "32px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          <p style={{ color: "#A1A1AA", fontSize: "14px", lineHeight: "1.6", margin: 0, minHeight: "44px" }}>
            {description}
          </p>
        </div>
        {isHighlighted && (
      ...
      <div style={{ marginBottom: "32px", display: "flex", alignItems: "baseline", gap: "10px" }}>
        {price !== "CUSTOM" && (
          <span style={{ fontSize: "24px", color: "#888", fontFamily: '"Geist Mono", monospace', fontWeight: 500 }}>
            $
          </span>
        )}
        <span
